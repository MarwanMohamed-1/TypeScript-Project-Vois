...
const registry = new Service_1.ServiceRegistery(services);
//Make optional parameter constructor
const registry2 = new Service_1.ServiceRegistery();
...
console.log(registry.retrieveEndpointsforGiveGroup(enums_1.ServiceGroup.SOLSTICE));
